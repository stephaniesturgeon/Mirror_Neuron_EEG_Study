...
[window, windowRect] = Screen('OpenWindow', screenNumber, [.5,.5, .5]*255, [10, 10, 1024, 700]);
...
varNames = {'Trial' 'ConditionCode' 'Condition' 'imgNum' 'imgName'};
varTypes = {'double' 'double' 'string' 'double' 'string'};
Altresults = table('Size', [30 5], 'VariableTypes', varTypes, 'VariableNames', varNames);
Altresults.Properties.Description = 'This table tracks the randomization of human/robot images';
...
for trial = 1:30   
    ...
    Altresults(trial, :) = {trial, thisTrialType, trialTypeLabel, thisExample, altImg};
    % Make the images into textures
    texAlt = Screen('MakeTexture', window, imgResize);
    ...
    WaitSecs(2); %show for image for 2 sec
